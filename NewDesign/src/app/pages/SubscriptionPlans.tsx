...
import { Plus, Edit, Trash2, Check, X, AlertCircle, XCircle, CheckCircle } from "lucide-react";
...
const initialPlans: Plan[] = [
  {
    ...
    features: [
      { name: "Basic AI Astro chat", included: true },
      { name: "Basic compatibility report", included: true },
      { name: "Basic horoscope", included: true },
      { name: "Basic birth chart - no detailed description", included: true },
      { name: "Add comments in community feed", included: false },
      { name: "Publish articles in community", included: false },
  ...
  },
  {
    ...
    status: "active",
    users: 8342,
    description: "Full access to all astrology features",
    features: [
      { name: "Advanced AI Astro chat", included: true },
      { name: "Advanced compatibility report", included: true },
      { name: "Detailed horoscope with predictions", included: true },
      { name: "Comprehensive birth chart with descriptions", included: true },
      { name: "Add comments in community feed", included: true },
      { name: "Publish articles in community", included: true },
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <div className="rounded-xl border border-[#e1e1e7] bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-3xl font-semibold text-blue-600">
            {plans.find((p) => p.name === "Free Plan")?.users.toLocaleString()}
          </p>
        </div>
        <div className="rounded-xl border border-[#e1e1e7] bg-white p-6 shadow-sm">
          <p className="text-sm text-[#6b6b88]">Premium Users</p>
          <p className="mt-2 text-3xl font-semibold text-purple-600">
            {plans.find((p) => p.name === "Premium Plan")?.users.toLocaleString()}
          </p>
        </div>
      </div>
